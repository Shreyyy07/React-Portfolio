...
const Contact = () => {
  ...
  <div className='container mx-auto'>
    <div className='flex flex-col lg:flex-row'>
      ...
      <div>
        <h4 className='text-[38px] uppercase text-accent font-medium mb-2 tracking-wide'>Let's Connect</h4>
        <h2 className='text-[38px] lg:text-[65px] leading-none mb-12'>
          Wanna know <br/> more!!...
        </h2>
      </div>
      </motion.div>
